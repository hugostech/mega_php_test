...
class AppController extends Controller
{
    ...
    /*
     * run the program, grab string and translate it.*/
    ...
    * update tanslated string item*/
    ...
    /*
     *  random translate string to five different languages*/
    ...
    /*
     * grab google support language list*/
    ...
    /*
     * translate string to specific language*/
    ...
    /*
     * list tanslated string and broken string*/
        ...
        $broken_format = <<<TABLE
                <tr>
                    <form method="post" action="?route=brokenFix">
                        <td>%s</td>
                        <td class="danger">%s('broken tags')</td>
                        <td><input type="text" name="translatedtext" value="%s" class="form-control"></td>
                        <td>
                            ...
                            <input type="hidden" name="langcode" value="%s">
                            <input type="submit" value="Fix" class="btn btn-sm btn-danger">
                        </td>
                    </form>
